...
class CatalogRetriever:
    ...
    def _fuzzy_match(self, query: str, records: List[Dict], key: str, top_k: int = 3) -> List[Dict]:
        ...
        ``records`` is a list of dicts; ``key`` is the dict field to compare.
        """
        if not query:
            return []
    ...
    def search_puja(self, query: str, top_k: int = 3) -> List[Dict]:
        ...
        Returns a list of matching puja dicts (or empty list if none)."""
    ...
    def search_pandit(self, query: str, top_k: int = 3) -> List[Dict]:
        ...
        Returns a list of matching pandit dicts (or empty list if none)."""
